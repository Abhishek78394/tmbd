  ...
  return (
    <div className='contactWrap'>
      <Container>
        ...
        <Row>
          <Col className='conectIcon mt-4'>
            <ul className='socialIconsList m-auto w-50 d-flex justify-content-around'>
              <li>
              ...
              <li>
                <a rel="noreferrer" href="/linkdin" target="_blank">
                  <BsLinkedin />
                </a>
              </li>
              <li>
              ...
              <li>
                <a rel="noreferrer" href="/overflow" target="_blank">
                  <BsStackOverflow />
                </a>
              </li>
              <li>
                <a rel="noreferrer" href="/google" target="_blank">
                  <BsGoogle />
                </a>
              </li>
              <li>
